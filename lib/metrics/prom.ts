...
import { OnApplicationBootstrap, OnApplicationShutdown } from '@nest_rabbit/nest';
import { createServer, Server } from 'http';
import {
  collectDefaultMetrics, Gauge, Histogram, Registry,
} from 'prom-client';
...
@Injectable()
export class PrometheusService implements OnApplicationBootstrap, OnApplicationShutdown {
